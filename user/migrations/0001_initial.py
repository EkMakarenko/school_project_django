...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pupils', to='education_process.pupilsgroup', verbose_name='Studying a ___th grade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teacher', to='education_process.pupilsgroup', verbose_name='Class teacher')),
                ('subjects', models.ManyToManyField(related_name='teachers', to='education_process.subject', verbose_name='Teach subject')),
